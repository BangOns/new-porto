...
export const frameworkFrontend = [
  ...
  { name: "Bootstrap", icon: BsBootstrap, hex: "#06B6D4" },
  { name: "Material UI", icon: SiMui, hex: "#06B6D4" },
  { name: "Shadcn UI", icon: SiShadcnui, hex: "#06B6D4" },
...
export const frameworkBackend = [
  { name: "Express", icon: SiExpress, hex: "#61DAFB" },
  { name: "Laravel", icon: SiLaravel, hex: null },
];
export const Database = [
  { name: "MySql", icon: SiMysql, hex: "#61DAFB" },
  { name: "PostgreSQL", icon: SiPostgresql, hex: null },
  { name: "MongoDb", icon: SiMongodb, hex: null },
];
